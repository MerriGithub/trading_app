...
COMMODITIES = {
    ...
    'instruments': {
        # Energy
        'WTI':       {
            'display': 'WTI Crude',    'data_source': 'csv', 'intraday_ticker': 'CL=F',
            'spread_pct': 0.0005,  'point_size': 1.0, 'sector': 'Energy',
            'cfd_contract_size': 1000.0, 'cfd_currency': 'USD',
            'spreadbet_min_stake': 0.04,
            'ig_price_override': True,
            'ig_default_price':  8985.0,
            'ig_market_name':    'Oil - WTI Crude (pence per barrel)',
            'ig_price_unit':     'pence_per_barrel',
            'ig_price_conversion': lambda p: round(p * 100, 1),  # USD/bbl → pence/bbl
            # Note: WTI excluded from pair generation via COMMODITY_EXCLUDE — Tab 3 manual use only.
        },
        'BRENT':     {
            'display': 'Brent Crude',  'data_source': 'csv', 'intraday_ticker': 'BZ=F',
            'spread_pct': 0.0005,  'point_size': 1.0, 'sector': 'Energy',
            'cfd_contract_size': 1000.0, 'cfd_currency': 'USD',
            'spreadbet_min_stake': 0.04,
            'ig_price_override': True,
            'ig_default_price':  9125.0,
            'ig_market_name':    'Oil - Brent Crude (pence per barrel)',
            'ig_price_unit':     'pence_per_barrel',
            'ig_price_conversion': lambda p: round(p * 100, 1),  # USD/bbl → pence/bbl
        },
        'NATGAS':    {
        ...
        # Agriculture
        'WHEAT':     {'display': 'Wheat',        'data_source': 'csv', 'intraday_ticker': 'ZW=F',  'spread_pct': 0.0010,  'point_size': 1.0, 'sector': 'Agriculture', 'cfd_contract_size':    5000.0, 'cfd_currency': 'USD', 'spreadbet_min_stake': 0.04},
        'CORN':      {'display': 'Corn',         'data_source': 'csv', 'intraday_ticker': 'ZC=F',  'spread_pct': 0.0008,  'point_size': 1.0, 'sector': 'Agriculture', 'cfd_contract_size':    5000.0, 'cfd_currency': 'USD', 'spreadbet_min_stake': 0.04},
        'SOYBEANS':  {'display': 'Soybeans',     'data_source': 'csv', 'intraday_ticker': 'ZS=F',  'spread_pct': 0.0008,  'point_size': 1.0, 'sector': 'Agriculture', 'cfd_contract_size':    5000.0, 'cfd_currency': 'USD', 'spreadbet_min_stake': 0.04},
        'COFFEE':    {
            'display': 'Coffee',       'data_source': 'csv', 'intraday_ticker': 'KC=F',
            'spread_pct': 0.0012,  'point_size': 1.0, 'sector': 'Agriculture',
            'cfd_contract_size': 37500.0, 'cfd_currency': 'USD',
            'spreadbet_min_stake': 0.04,
            'ig_price_override': True,
            'ig_default_price':  24300.0,
            'ig_market_name':    'Coffee - New York Arabica (pence per lb)',
            'ig_price_unit':     'pence_per_lb',
            'ig_price_conversion': lambda p: round(p * 100, 1),  # USc/lb → pence/lb
        },
        'SUGAR':     {
            'display': 'Sugar',        'data_source': 'csv', 'intraday_ticker': 'SB=F',
            'spread_pct': 0.0012,  'point_size': 1.0, 'sector': 'Agriculture',
            'cfd_contract_size': 112000.0, 'cfd_currency': 'USD',
            'spreadbet_min_stake': 0.04,
            'ig_price_override': True,
            'ig_default_price':  1449.0,
            'ig_market_name':    'Sugar - New York No.11 (pence per lb)',
            'ig_price_unit':     'pence_per_lb',
            'ig_price_conversion': lambda p: round(p * 100, 1),  # USc/lb → pence/lb
        },
    },
